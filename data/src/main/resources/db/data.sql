...
SELECT "Александр", "Гилимович", "Сергеевич","1990-11-12", gender.gender_id, "белорус", f.family_status_id, NULL, "a.gilimovich@gmail.com", "безработный", 1, NULL
FROM gender, family_status AS f WHERE f.family_status_value="single" AND gender.gender_value="male";

INSERT INTO attachment(upload_date, attach_name, comment, file, contact) VALUES ("2017-03-12 14:20:51", "Имя присоединения","без комментариев", NULL, 1);
